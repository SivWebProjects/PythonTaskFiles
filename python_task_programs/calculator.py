...
#Importing all functions from MathModule module
...
while char == 'y' or char == 'Y':
    ...
    operation = input('Please enter the operator + for addition, - for subtraction, * for multiplication and / for division: ')
