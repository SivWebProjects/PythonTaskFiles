...
def text():
    """The user entered text is recieved when the user clicks on the submit button
    ...
    Return type:
        str: emotion and score
    """
    # In form[text] text is the value of the name attribue of an input text element
...
# good sentiment_dict = {'neg': 0.0, 'neu': 0.0, 'pos': 1.0, 'compound': 0.4404}